...
INSERT INTO roles (name) VALUES ('ADMIN'), ('DOCENTE'), ('ESTUDIANTE');
INSERT INTO users (email, password, role_id, status, verified, created_at)
VALUES ('admin@upc.edu.pe', 'password_encriptado', (SELECT id FROM roles WHERE name='ADMIN'), 'ACTIVE', true, NOW());
